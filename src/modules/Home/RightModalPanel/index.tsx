...
import { ArtifactResponse, Template } from 'src/api/types';

import { ModelForm } from './ModelForm';
import { RIGHT_PANEL_TYPE } from '../types';
import { HistoryChanges } from './HistoryChanges';
import { Templates } from './Templates';
import { FORM_MODE } from './ModelForm/types';

interface RightModalPanelProps {
...
export const RightModalPanel = ({
  ...
  if (activeStatus === RIGHT_PANEL_TYPE.ADD_TEMPLATE) {
    return <Templates templates={templates} onClose={onClose} updateTemplates={updateTemplates} />;
  }
