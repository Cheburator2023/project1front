...
* Значение поля «Владелец Модели/Алгоритма» должно частично совпадать со значением ФИО Бизнес-заказчика из Keycloak
...
1. Идентификатор версии модели. system_model_id. Недоступно для редактирования.
2. Алиас модели. model_alias. Недоступно для редактирования.
3. Название модели. model_name. Недоступно для редактирования.
4. Название модели в реестре ДАДМ. model_name_dadm. Недоступно для редактирования.
5. Владелец Модели/Алгоритма. business_customer. Недоступно для редактирования.
